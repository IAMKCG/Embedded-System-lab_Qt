...
NewNetGame::NewNetGame(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::NewNetGame)
{
    ui->setupUi(this);
...
void NewNetGame::mouseReleaseEvent(QMouseEvent * event)
{
    int x,y;
    if (mouseflag==true)
    {
...
void NewNetGame::paintEvent(QPaintEvent *)
{
    QPainter p(this);
